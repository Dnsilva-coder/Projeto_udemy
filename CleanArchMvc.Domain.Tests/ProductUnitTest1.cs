...
namespace CleanArchMvc.Domain.Tests
{
    public class ProductUnitTest1
    {
        ...
        public void CreateProduct_NegativeIdValue_DomainExceptionInvalidId()
        {
            ...
            action.Should().Throw<CleanArchMvc.Domain.Validation.DomainExceptionValidaion>()
        ...
        public void CreateProduct_WithNullImageName_NoDomainException()
        {
            ...
            action.Should().NotThrow<CleanArchMvc.Domain.Validation.DomainExceptionValidaion>();
        }

        [Fact]
        public void CreateProduct_WithNullImageName_NoNullRegerenceException()
        {
            Action action = () => new Product(1, "Product Name", "Product Description", 9.99m, 99, null);
